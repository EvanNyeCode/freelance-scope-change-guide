# Free freelance quote, project estimate, and scope-change templates
...
For a scope-change decision record, see the [freelance scope-change decision record](freelance-scope-change-decision-record.md).
...
`project quote = (delivery hours + admin and revision hours) Ã— internal rate + real expenses + justified adjustment`

Many freelancers use an hourly rate calculator before this step: derive a sustainable internal rate from the income target, business costs, realistic billable hours, and an operating buffer, then apply that rate to the project estimate. Keep the rate as a planning input rather than presenting an arbitrary market number.
